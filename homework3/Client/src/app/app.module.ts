...
import { UsersService} from './shared/services/login/login.service';
...
@NgModule({
  ...
  providers: [PetshopsService, ModelResolver, UsersService, PetshopCommentsResolver, UsersResolver, PetshopListResolver],
